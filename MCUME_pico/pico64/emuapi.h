...
// use this to find the port masks:
// PORT A = 1 << (index in array / 8)
// PORT B = 1 << (index in array % 8)
const unsigned short matrix_keys[] = {
//  0     1     2     3     4     5     6     7
  0x38, 0x39, 0x3A, 0x3F, 0x3C, 0x3D, 0x3E, 0x3B, // A
  0x08, 0x09, 0x0A, 0x0F, 0x0C, 0x0D, 0x0E, 0x0B, // B
  0x10, 0x11, 0x12, 0x17, 0x14, 0x15, 0x16, 0x13, // C
  0x18, 0x19, 0x1A, 0x1F, 0x1C, 0x1D, 0x1E, 0x1B, // D
  0x20, 0x21, 0x22, 0x27, 0x24, 0x25, 0x26, 0x23, // E
  0x28, 0x29, 0x2A, 0x2F, 0x2C, 0x2D, 0x2E, 0x2B, // F
  0x30, 0x31, 0x32, 0x37, 0x34, 0x36, 0x36, 0x33, // G
  0x00, 0x01, 0x02, 0x07, 0x04, 0x05, 0x06, 0x03  // H
};
#endif
